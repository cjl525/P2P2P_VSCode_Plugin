...
> The checked-in `p2p2p-0.0.1.vsix` was created before the LaTeX preview, PDF generator, and PlantUML flow existed. Build and install a fresh VSIX (≥0.0.4) from this branch so all commands appear.
